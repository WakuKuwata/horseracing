...
def make_fetcher(min_interval: float | None = None, cache_dir: str | None = None) -> HttpFetcher:
    """A polite fetcher reusing scrape's robots/rate-limit/backoff (FR-014).
